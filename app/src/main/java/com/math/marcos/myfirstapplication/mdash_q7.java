 ...
 */
public class mdash_q7 extends Activity {
    Random r = new Random();
    int a = r.nextInt(400 - 100) + 100;
    int b = r.nextInt(900 - 500) + 500;
    int d = r.nextInt(900 - 500) + 500;
    int c = b + a + d;
    ...
    public void onButtonClick(View v) {
        ...
        if (v.getId() == R.id.menu) {
            Intent i = new Intent(mdash_q7.this, MainActivity.class);
            startActivity(i);}
        if (v.getId() == R.id.submit) {
            ...
            if (useranswerss == c) {
                ...
                int seconds7 = (int)(elapsedtime);
                Intent i = new Intent(mdash_q7.this, mdash_q8.class);
