...
public class marathon_q2 extends Activity{
    Random r = new Random();
    ...
    public void onButtonClick(View v) {
        ...
        if (v.getId() == R.id.menu) {
            Intent i = new Intent(marathon_q2.this, MainActivity.class);
            startActivity(i);}
        if (v.getId() == R.id.submit) {
            ...
            if (useranswerss == c){
                level ++;
                Intent b = new Intent(marathon_q2.this, marathon_q3.class);
                b.putExtra("level", level);
                startActivity(b);}

            else {
                Intent b = new Intent(marathon_q2.this, marathon_finished.class);
                b.putExtra("level", level);
                b.putExtra("c", c);
                startActivity(b);}
        }
